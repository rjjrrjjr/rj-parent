...
//						System.out.println(lastContents);
    ...
    public static void main(String[] args) throws Exception {
        //MyExcel2007ForPaging reader = new MyExcel2007ForPaging("E:\\产品需求\\alog\\仓内薪酬\\测试数据-1212\\rj\\人员信息.xlsx",2,100);

        //System.out.println("\n---"+reader.dataList);
        System.getProperties().entrySet().forEach(System.out::println);

        System.out.println("==============================");
        //System.out.println(System.getProperty("user.dir") + "../uploadFile/employee" + new Date().getTime() + "_" +filename);
